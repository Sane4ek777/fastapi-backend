...
def generate_slug(name: str) -> str:
    """Генерирует slug из названия товара с транслитерацией кириллицы в латиницу."""
    ...
    name = re.sub(r'[^a-zA-Z0-9\-а-яА-ЯёЁ\s]', '', name)  # Оставляем кириллицу (временно) для транслитерации
